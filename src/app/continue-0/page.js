...
export default function Page() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-24">
            ...
            <h2 className="text-2xl font-semibold animate-[wiggle_1s_ease-in-out_infinite]">Doorgaan knop zorgt ervoor dat je gaat beginnen,zorg dat je op elke stap de volledige pagina in je opneemt en alles leest.
